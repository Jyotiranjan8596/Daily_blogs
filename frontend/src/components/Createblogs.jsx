...
function Createblogs() {
    ...
    //     });
    let result=axios.post('http://localhost:8000/api/create-post', formData, {
        headers: {
    ...
    <div className='bg-gray-800 flex flex-col justify-center h-screen'>
      ...
      <form onSubmit={createPost} className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
        ...
        <div className='flex flex-col text-gray-400 py-2'>
          ...
          <input type="file"  onChange={(e)=>{setImage(e.target.files)}} name="image" className='rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue-500 focus:bg-gray-800 focus:outline-none' />
        </div>
